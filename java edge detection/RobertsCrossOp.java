...
/* Uses the RobertsCrossOperator for edge detection
 */
 
public class RobertsCrossOp{
	 ...
	 */
	public RobertsCrossOp(Image p_originalImage){
	...
	/* implements roberts cross algorithm
	 */
	private void edgeAlgorithm(int[] processedpixels){
		...
		for(int r = 0; r < height - 1; r++){
			for(int c = 0; c < width - 1; c++){
				...
				finalmatrix[r][c] = Math.max(temp1, temp2);
				/*Simplest operator
